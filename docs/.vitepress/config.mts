      ...
      '/computer-network/content': [
        {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                { text: '第一节 通信基础', link: '/computer-network/content/physical-layer/section-1' },
                { text: '第二节 传输介质', link: '/computer-network/content/physical-layer/section-2' },
                { text: '第三节 物理层设备', link: '/computer-network/content/physical-layer/section-3' },
              ],
            },
            {
              text: '第三章 数据链路层',
              ...
              items: [
                { text: '第一节 数据链路层的功能', link: '/computer-network/content/data-link-layer/section-1' },
                { text: '第二节 组帧', link: '/computer-network/content/data-link-layer/section-2' },
                { text: '第三节 差错控制', link: '/computer-network/content/data-link-layer/section-3' },
                { text: '第四节 流量控制与可靠传输机制', link: '/computer-network/content/data-link-layer/section-4' },
                { text: '第五节 介质访问控制', link: '/computer-network/content/data-link-layer/section-5' },
                { text: '第六节 局域网', link: '/computer-network/content/data-link-layer/section-6' },
                { text: '第七节 广域网', link: '/computer-network/content/data-link-layer/section-7' },
                { text: '第八节 数据链路层设备', link: '/computer-network/content/data-link-layer/section-8' },
              ],
            },
            {
              text: '第四章 网络层',
              ...
              items: [
                { text: '第一节 网络层的功能', link: '/computer-network/content/network-layer/section-1' },
                { text: '第二节 IPv4', link: '/computer-network/content/network-layer/section-2' },
                { text: '第三节 IPv6', link: '/computer-network/content/network-layer/section-3' },
                { text: '第四节 路由算法与路由协议', link: '/computer-network/content/network-layer/section-4' },
                { text: '第五节 IP 多播', link: '/computer-network/content/network-layer/section-5' },
                { text: '第六节 移动 IP', link: '/computer-network/content/network-layer/section-6' },
                { text: '第七节 网络层设备', link: '/computer-network/content/network-layer/section-7' },
              ],
            },
            {
              text: '第五章 传输层',
              ...
              items: [
                { text: '第一节 传输层提供的服务', link: '/computer-network/content/transport-layer/section-1' },
                { text: '第二节 UDP', link: '/computer-network/content/transport-layer/section-2' },
                { text: '第三节 TCP', link: '/computer-network/content/transport-layer/section-3' },
              ],
            },
            {
              text: '第六章 应用层',
              ...
              items: [
                { text: '第一节 网络应用模型', link: '/computer-network/content/application-layer/section-1' },
                { text: '第二节 域名系统', link: '/computer-network/content/application-layer/section-2' },
                { text: '第三节 文件传输协议', link: '/computer-network/content/application-layer/section-3' },
                { text: '第四节 电子邮件', link: '/computer-network/content/application-layer/section-4' },
                { text: '第五节 万维网', link: '/computer-network/content/application-layer/section-5' },
              ],
            },
          ],
        },
      ...
      '/computer-network/practice': [
        {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                { text: '第一节 通信基础', link: '/computer-network/practice/physical-layer/section-1' },
                { text: '第二节 传输介质', link: '/computer-network/practice/physical-layer/section-2' },
                { text: '第三节 物理层设备', link: '/computer-network/practice/physical-layer/section-3' },
              ],
            },
            {
              text: '第三章 数据链路层',
              ...
              items: [
                { text: '第一节 数据链路层的功能', link: '/computer-network/practice/data-link-layer/section-1' },
                { text: '第二节 组帧', link: '/computer-network/practice/data-link-layer/section-2' },
                { text: '第三节 差错控制', link: '/computer-network/practice/data-link-layer/section-3' },
                { text: '第四节 流量控制与可靠传输机制', link: '/computer-network/practice/data-link-layer/section-4' },
                { text: '第五节 介质访问控制', link: '/computer-network/practice/data-link-layer/section-5' },
                { text: '第六节 局域网', link: '/computer-network/practice/data-link-layer/section-6' },
                { text: '第七节 广域网', link: '/computer-network/practice/data-link-layer/section-7' },
                { text: '第八节 数据链路层设备', link: '/computer-network/practice/data-link-layer/section-8' },
              ],
            },
            {
              text: '第四章 网络层',
              ...
              items: [
                { text: '第一节 网络层的功能', link: '/computer-network/practice/network-layer/section-1' },
                { text: '第二节 IPv4', link: '/computer-network/practice/network-layer/section-2' },
                { text: '第三节 IPv6', link: '/computer-network/practice/network-layer/section-3' },
                { text: '第四节 路由算法与路由协议', link: '/computer-network/practice/network-layer/section-4' },
                { text: '第五节 IP 多播', link: '/computer-network/practice/network-layer/section-5' },
                { text: '第六节 移动 IP', link: '/computer-network/practice/network-layer/section-6' },
                { text: '第七节 网络层设备', link: '/computer-network/practice/network-layer/section-7' },
              ],
            },
            {
              text: '第五章 传输层',
              ...
              items: [
                { text: '第一节 传输层提供的服务', link: '/computer-network/practice/transport-layer/section-1' },
                { text: '第二节 UDP', link: '/computer-network/practice/transport-layer/section-2' },
                { text: '第三节 TCP', link: '/computer-network/practice/transport-layer/section-3' },
              ],
            },
            {
              text: '第六章 应用层',
              ...
              items: [
                { text: '第一节 网络应用模型', link: '/computer-network/practice/application-layer/section-1' },
                { text: '第二节 域名系统', link: '/computer-network/practice/application-layer/section-2' },
                { text: '第三节 文件传输协议', link: '/computer-network/practice/application-layer/section-3' },
                { text: '第四节 电子邮件', link: '/computer-network/practice/application-layer/section-4' },
                { text: '第五节 万维网', link: '/computer-network/practice/application-layer/section-5' },
              ],
            },
          ],
        },
          ...
          items: [
            { text: '操作系统考点总览', link: '/operating-system/content/' },
            {
              ...
              items: [
                ...
                { text: '第三节 操作系统的运行环境', link: '/operating-system/content/computer-system-overview/section-3' },
                { text: '第四节 操作系统结构', link: '/operating-system/content/computer-system-overview/section-4' },
                { text: '第五节 操作系统引导', link: '/operating-system/content/computer-system-overview/section-5' },
                { text: '第六节 虚拟机', link: '/operating-system/content/computer-system-overview/section-6' },
              ],
            },
            {
              text: '第二章 进程与线程',
              ...
              items: [
                ...
                { text: '第四节 死锁', link: '/operating-system/content/processes-threads/section-4' },
              ],
            },
            {
              text: '第三章 内存管理',
            ...
            },
            {
              ...
              items: [
                ...
                { text: '第三节 文件系统', link: '/operating-system/content/file-management/section-3' },
              ],
            },
            {
              text: '第五章 输入/输出管理',
              ...
              items: [
                ...
                { text: '第三节 磁盘和固态硬盘', link: '/operating-system/content/io-management/section-3' },
              ],
            },
          ],
        },
          ...
          items: [
            { text: '操作系统例题总览', link: '/operating-system/practice/' },
            {
              ...
              items: [
                ...
                { text: '第三节 操作系统的运行环境', link: '/operating-system/practice/computer-system-overview/section-3' },
                { text: '第四节 操作系统结构', link: '/operating-system/practice/computer-system-overview/section-4' },
                { text: '第五节 操作系统引导', link: '/operating-system/practice/computer-system-overview/section-5' },
                { text: '第六节 虚拟机', link: '/operating-system/practice/computer-system-overview/section-6' },
              ],
            },
            {
              text: '第二章 进程与线程',
              ...
              items: [
                ...
                { text: '第四节 死锁', link: '/operating-system/practice/processes-threads/section-4' },
              ],
            },
            {
              text: '第三章 内存管理',
            ...
            },
            {
              ...
              items: [
                ...
                { text: '第三节 文件系统', link: '/operating-system/practice/file-management/section-3' },
              ],
            },
            {
              text: '第五章 输入/输出管理',
              ...
              items: [
                ...
                { text: '第三节 磁盘和固态硬盘', link: '/operating-system/practice/io-management/section-3' },
              ],
            },
          ],
        },
